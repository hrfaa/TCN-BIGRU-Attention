...
% data = data(1:636,3);
[h1,l1]=data_process(data,8); %步长为12
res = [h1,l1];
...
% 优化参数设置
lb = [0.001 10 2  2]; %参数的下限。分别是学习率，biGRU的神经元个数，注意力机制的键值, 卷积核大小    在此模型中可以将ATTANTION删掉
...
filename = 'C:\Users\17384\Desktop\daima\TCN-BIGRU（matlab）\predict.xlsx';
xlswrite(filename, y_test_predict, 1, 'A1');

str={'真实值','TCN-BiGRU','最终结果'};
str1=str(2:end);
